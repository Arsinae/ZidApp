...
export class MyApp {
  ...
  constructor(
    ...
    this.pages = [
      ...
      { title: 'Liste des Restaurants', component: RestaurantListPage},
      { title: 'Carte', component: LocalizePage},
      { title: 'Categorie de restaurants', component: CategorizerestaurantPage},
      { title: 'Secret', component: ZidanePage}
    ];
  }
